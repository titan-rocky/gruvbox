...
let s:gb.dark0       = ['#262e35', 235]     " 40-40-40
let s:gb.dark0_soft  = ['#273138', 236]     " 50-48-47
let s:gb.dark1       = ['#3C4349', 237]     " 60-56-54
let s:gb.dark2       = ['#51585D', 239]     " 80-73-69
let s:gb.dark3       = ['#676D72', 241]     " 102-92-84
let s:gb.dark4       = ['#767a7c', 243]     " 124-111-100
let s:gb.dark4_256   = ['#7c6f64', 243]     " 124-111-100

let s:gb.gray_245    = ['#BFBDA6', 245]     " 146-131-116
let s:gb.gray_244    = ['#928374', 244]     " 146-131-116

let s:gb.light0_hard = ['#f9f5d7', 230]     " 249-245-215
let s:gb.light0      = ['#e2e1cf', 229]     " 253-244-193
...
let s:gb.bright_red     = ['#d38275', 167]     " 251-73-52
let s:gb.bright_green   = ['#a3c68f', 142]     " 184-187-38
let s:gb.bright_yellow  = ['#e8c677', 214]     " 250-189-47
let s:gb.bright_blue    = ['#83a598', 109]     " 131-165-152
let s:gb.bright_purple  = ['#aaa1b0', 175]     " 211-134-155
let s:gb.bright_aqua    = ['#8ec07c', 108]     " 142-192-124
let s:gb.bright_orange  = ['#e59f65', 208]     " 254-128-25

let s:gb.neutral_red    = ['#b56661', 124]     " 204-36-29
let s:gb.neutral_green  = ['#8daf77', 106]     " 152-151-26
let s:gb.neutral_yellow = ['#c69d54', 172]     " 215-153-33
let s:gb.neutral_blue   = ['#458588', 66]      " 69-133-136
let s:gb.neutral_purple = ['#8f87a0', 132]     " 177-98-134
let s:gb.neutral_aqua   = ['#84b297', 72]      " 104-157-106
let s:gb.neutral_orange = ['#cc8250', 166]     " 214-93-14
